...
proc P4080DS_init_core {} {
	...
	# define   1GB TLB entry  7: 0x00000000 - 0x3FFFFFFF for DDR     cache inhibited
	reg ${CAM_GROUP}L2MMU_CAM7 = 0xA000000E1C0800000000000000000001
	
	# define   1GB TLB entry  8: 0x40000000 - 0x7FFFFFFF for DDR     cache inhibited
	reg ${CAM_GROUP}L2MMU_CAM8 = 0xA000000E1C0800004000000040000001
	
	# define   1MB TLB entry  9: 0xF4000000 - 0xF40FFFFF for BMAN    cache inhibited
	reg ${CAM_GROUP}L2MMU_CAM9 = 0x500000081C080000F4000000F4000001
	...
	reg ${CAM_GROUP}L2MMU_CAM11 = 0x500000081C080000F4200000F4200001
    ...
    reg ${SPR_GROUP}BUCSR = 0x00000201
